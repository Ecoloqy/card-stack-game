...
export const ForestIcon = ({ width = '20px', height = '20px', fillColor = 'white', strokeColor = 'none' }: IconProps): ReactElement => {
    return (
        <>
            <svg height={height} width={width} fill={fillColor} stroke={strokeColor} version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 227" xmlSpace="preserve">
